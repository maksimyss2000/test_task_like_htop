...
void WorkerCommonCpu::calculateUsage(Measurement& measurement) {
    ...
    measurement.utilization = 100 * (1 - measurement.idle_difference / measurement.total_time_difference);
}  
